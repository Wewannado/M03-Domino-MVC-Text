/*
 * Author https://benohead.com/java-vertical-label-in-swing/
 */
package utils;
...
public class VerticalLabelUI extends JLabel {
    ...
    public VerticalLabelUI(Icon image, int horizontalAlignment) {
        super(image, horizontalAlignment);
    }

    public VerticalLabelUI(Icon image) {
        super(image);
    }

    public VerticalLabelUI(String text, Icon icon, int horizontalAlignment) {
        super(text, icon, horizontalAlignment);
    }

    public VerticalLabelUI(String text, int horizontalAlignment) {
        super(text, horizontalAlignment);
    }

    public VerticalLabelUI(String text) {
        super(text);
    }
